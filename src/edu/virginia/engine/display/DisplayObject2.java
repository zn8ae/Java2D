...
public class DisplayObject2 {
	 ...
	 */
	public DisplayObject2(String id) {
		this.setId(id);

	}

	public DisplayObject2(String id, String fileName) {
		this.setId(id);
	...
	public boolean collidesWith(DisplayObject2 other) {
...
//			g.drawOval(0, 0, 5, 5);
    ...
    public void setParent(DisplayObject2 parent)
    {
        this.parent = parent;
    }

    public DisplayObject2 getParent()
    {
        return this.parent;
    }
